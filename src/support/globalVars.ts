import {GlobalVarValue, TASK_GET_GLOBAL_VAR, TASK_SET_GLOBAL_VAR} from '../plugins/globalVars';
 ...
 */
export function getGlobalVar<T extends GlobalVarValue = GlobalVarValue>(key: string): Cypress.Chainable<T | null> {
 ...
 */
export function setGlobalVar<T extends GlobalVarValue>(key: string, value: T): Cypress.Chainable<null> {
