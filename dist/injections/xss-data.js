...
exports.xssData = [
    ...
    '"`\'><p>ABC<div style="font-family:\'foo\'\\x7Dx:expression(javascript:alert(1);/*\';">DEF',
    '"`\'><p>ABC<div style="font-family:\'foo\'\\x3Bx:expression(javascript:alert(1);/*\';">DEF',
